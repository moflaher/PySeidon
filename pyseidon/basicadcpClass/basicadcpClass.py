...
#Local import
from variablesbasicAdcp import _load_basicadcp
from functionsbasicAdcp import *
from plotsbasicAdcp import *
...
class basicADCP:
    ...
    *Notes*
    ...
    def __init__(self, filename, debug=False):
        ...
        self.Variables = _load_basicadcp(self, self.History, debug=self._debug)
        self.Plots = PlotsbasicAdcp(self.Variables, debug=self._debug)
        self.Utils = FunctionsbasicAdcp(self.Variables,
                                   self.Plots,
                                   self.History,
                                   debug=self._debug) 
